...
%global project         dlclark
%global repo            regexp2
# https://github.com/dlclark/regexp2
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     %{provider_prefix}
%global commit          487489b64fb796de2e55f4e8a4ad1e145f80e957
%global shortcommit     %(c=%{commit}; echo ${c:0:7})

Name:           golang-%{provider}-%{project}-%{repo}
Version:        1.1.6
Release:        3%{?dist}
Summary:        A regex engine for Go based on the .NET engine
License:        MIT
...
cp -pav ./testoutput1 %{buildroot}/%{gopath}/src/%{import_path}/
echo "%%{gopath}/src/%%{import_path}/testoutput1" >> unit-test-devel.file-list
